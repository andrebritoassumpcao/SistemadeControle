                            ...
                            if(mysqli_num_rows($query_run) > 0)
                            {
                                ...
                                <div class="container-md row g-3 mb-3" >
                                  <div class="col">
                                    ...
                                    <select class="form-select"  value="<?= $professor['turno']; ?>" name="turno" id="turno" required>
                                  ...
                                  <div class="col">
                                    ...
                                    <input type="text" class="form-control"  value="<?= $professor['turma']; ?>" name="turma" id="turma">
                                  </div>
                                </div>
